# labeling_tool
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!현재 촬영이미지 통신 방법을 수정하고 있어 카메라를 사용하는 촬영 2번째 창 이후 작업은 불가능 합니다. 또한 현재 등록 작업의 현재 등록된 환경, 물품들을 삭제할 수 있는 기능을 추가중입니다. 버튼은 설정이 되어있나 기능이 덜 구현되어있기 때문에 클릭을 하지 않는 것이 좋습니다!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
## 필요 설치모듈
Python3.7, PyQt5(5.14), opencv-python(4.2.0.34), pillow(7.1.2), paho-mqtt(1.5.0), PyMySQL(0.9.3) 추후 한번에 설치할 수 있는 스크립트를 
